        ...
        <div className='pb-9'>
            ...
            <div>
                ...
                <button 
                    ...
                    style={{border : '1px solid white', borderRadius : '20px', padding: '10px'}
                ...
                <div className="flex gap-1 justify-between px-1 mb-2 lg:pt-2 ">
                    <div className="flex gap-2 ">
                        <FcLikePlaceholder onClick={like}  className="bg-red-500 rounded-full p-1 w-5 h-5 lg:w-6 lg:h-6" />
                        <FaRetweet className="bg-green-500 rounded-full p-1 w-5 h-5 lg:w-6 lg:h-6" />
                        <FcDislike onClick={dislike} className="bg-blue-500 rounded-full p-1 w-5 h-5 lg:w-6 lg:h-6" />
                        <p className='lg:text-base'>likes {likes}</p>
                        <p className='lg:text-base'>dislikes {dislikes}</p>
                    </div>
